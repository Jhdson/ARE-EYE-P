...
const LGUmanagecatacomb = () => {
    const data = [
        {
          catacombID: 'CTM153',
          catacomblocation: 'SECTION A',
          date: '2024-10-18',
  ...
  return (
    ...
    <Box sx={{ padding: 4 }}>
      <Paper sx={{ padding: 2 }}>
        <h2>Manage Catacombs Availability</h2>
            ...
            <TableBody>
              {data.map((row, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>{row.catacomblocation}</TableCell>
...
export default LGUmanagecatacomb;